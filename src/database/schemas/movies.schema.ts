...
export const moviesTable = pgTable('movies', {
  ...
  // Tiny base64 webp previews (next/image placeholder="blur"), generated by
  // the scraper from the smallest TMDB variants; a few hundred bytes each.
  posterBlurDataUrl: text(),
  backdropBlurDataUrl: text(),
